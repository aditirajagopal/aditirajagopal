    ...
    <>
      ...
      >
        ...
        <div className="db dtc-l v-mid w-100 w-75-l tc tr-l">
          ...
          <Link className="link dim text f6 f5-l dib mr3 mr4-l" to="https://github.com/aditirajagopal/aditirajagopal/blob/master/src/components/Aditi_Rajagopal_Portfolio.pdf" title="Portfolio">portfolio</Link>
